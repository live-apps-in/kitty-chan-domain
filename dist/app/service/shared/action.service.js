...
let ActionService = class ActionService {
    ...
    call(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const config = yield new ActionFactory().getActionConfig(payload.type, payload.guild, payload.body);
...
class ActionFactory {
    getActionConfig(type, guild, body) {
        return __awaiter(this, void 0, void 0, function* () {
            const { guildId, userId } = guild;
            const config = {};
            switch (type) {
                case action_1.ACTIONS.setRole:
