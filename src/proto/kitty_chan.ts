...
import type {
  GuildServiceClient as _kitty_chan_GuildServiceClient,
  GuildServiceDefinition as _kitty_chan_GuildServiceDefinition,
} from './kitty_chan/GuildService';
import type {
  ReactionRoleServiceClient as _kitty_chan_ReactionRoleServiceClient,
  ReactionRoleServiceDefinition as _kitty_chan_ReactionRoleServiceDefinition,
} from './kitty_chan/ReactionRoleService';
...
export interface ProtoGrpcType {
  kitty_chan: {
    ...
    GuildService: SubtypeConstructor<
      typeof grpc.Client,
      _kitty_chan_GuildServiceClient
    > & { service: _kitty_chan_GuildServiceDefinition };
    ...
    ReactionRoleService: SubtypeConstructor<
      typeof grpc.Client,
      _kitty_chan_ReactionRoleServiceClient
    > & { service: _kitty_chan_ReactionRoleServiceDefinition };
