...
import type {
  DiscordEmbedFields as _kitty_chan_DiscordEmbedFields,
  DiscordEmbedFields__Output as _kitty_chan_DiscordEmbedFields__Output,
} from '../kitty_chan/DiscordEmbedFields';
