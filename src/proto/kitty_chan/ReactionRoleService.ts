...
import type {
  ReactionRoleActionResDto as _kitty_chan_ReactionRoleActionResDto,
  ReactionRoleActionResDto__Output as _kitty_chan_ReactionRoleActionResDto__Output,
} from '../kitty_chan/ReactionRoleActionResDto';
...
export interface ReactionRoleServiceClient extends grpc.Client {
  reactionRolesAction(
    ...
    callback: grpc.requestCallback<_kitty_chan_ReactionRoleActionResDto__Output>,
...
export interface ReactionRoleServiceDefinition extends grpc.ServiceDefinition {
  reactionRolesAction: MethodDefinition<
    ...
    _kitty_chan_ReactionRoleActionResDto,
    _kitty_chan_ReactionRoleActionReqDto__Output,
    _kitty_chan_ReactionRoleActionResDto__Output
  >;
}
